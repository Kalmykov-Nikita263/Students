...
public class EditFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.student_edit, container, false);
    ...
    private void saveStudent() {
        studentController.update(new Student(nameEditText.getText().toString(), lastNameEditText.getText().toString(), middleNameEditText.getText().toString(), (Date) birthDateEditText.getText(), Objects.requireNonNull(groupController.getAllGroups().getValue()).get(0).toString()));
    }
}
